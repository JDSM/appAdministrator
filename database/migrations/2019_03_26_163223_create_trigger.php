...
class CreateTrigger extends Migration
{
    ...
    public function up()
    {
        ...
        DB::unprepared('CREATE TRIGGER tr_updStockIngresoAnularCostArt AFTER UPDATE ON ingresos FOR EACH ROW BEGIN UPDATE costo_articulos ca  JOIN detalle_ingreso di ON di.id = ca.id_detalle_ingreso AND di.idingreso = NEW.id SET ca.cantidad = 0; END;');
