                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row border">
                            ...
                            <template v-if="tipo_venta=='CREDITO'" >
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <template v-else-if="tipo_venta=='CONTADO'" >
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Tipo Comprobante(*)</label>
                                        <select class="form-control" v-model="tipo_comprobante">
                        ...
                        <div class="form-group row border">
                            <div class="col-md-5 row" style="padding-right: 0px;">
                                <div class="col-md-12">
                                    <div class="form-group">
                            ...
                            <div class="col-md-7 row" style="padding-left: 5px;">
                                ...
                                <div class="col-md-2"  style="padding-right: 0px;">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="0" step="any" class="form-control" v-model="contenido" disabled>
                                    </div>
                                </div>
                                <div class="col-md-2"  style="padding-right: 0px;">
                                    <div class="form-group">
            ...
            buscarArticulo(){
                ...
                axios.get(url).then(function (response) {
                    ...
                    if (me.arrayArticulo.length>0){
                        ...
                        me.contenido=me.arrayArticulo[0]['contenido'];
                    }
                    else{
